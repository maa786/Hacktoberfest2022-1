...
class CircularLinkedList:
	...
	def findNode(self,element):
		...
		if(self.head == None):
			...
			while(True):	
				# Comparing the elements of each node to the element to be searched
				...
				# If we reach the head again then element is not present in the list so we will break the loop
